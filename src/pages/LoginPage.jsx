...
function LoginPage() {
  ...
  const { userAuth, error, loginUser,validateToken } = useContextApp();
  ...
  return (
    <div className='w-full flex flex-col gap-5 justify-start items-center h-[90vh]'>
      ...
      <form onSubmit={handleSubmit(handlerOnsubmit)} className='bg-[#201E24] flex justify-start border-2 items-start py-5 px-5 flex-col gap-5 rounded-lg border-[#bfdbff2f] w-[18rem] min-h-[2rem]'>
        <Input
          nameInput="email"
